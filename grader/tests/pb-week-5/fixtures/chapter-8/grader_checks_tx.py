"""
Authoritative tests for chapter-8, lifted out of tx.py.
...
# Brings in the function under test plus whatever tx.py imports at module
# level, which is what the test bodies below reach for.
from tx import *  # noqa: F401,F403
